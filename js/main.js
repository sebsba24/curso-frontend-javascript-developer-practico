...
productList.push({
    ...
    info: 'The best Bike in the world '
});
...
productList.push({
    ...
    price: 220,
    image: 'https://images.pexels.com/photos/276517/pexels-photo-276517.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    info: 'With the highest definition on a screen you ever seen'
});
...
productList.push({
    ...
    price: 100,
    image: 'https://images.pexels.com/photos/276517/pexels-photo-276517.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940',
    info: 'Your flower will be so comfortable'
});
...
function renderProducts(arr){
    ...
    for (product of arr){
        ...
        // * product = {name, price, image} -> prouct.image
